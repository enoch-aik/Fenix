  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize: Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height * 0.183),
        child: Container(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    MenuTitle(icon: "Dacha.png", title: "Dacha",),
        ...
        children: [
          Container(
            ...
            child:Row(
              children: [
                Icon(Icons.location_on, size: 17.w,),
                Text(" Deliver to chicago,iL 5932 ",
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Icon(CustomIcons.crown_badge, color: Color(0xFFFCC70A),size: 42.w,)
                  ),
                  Text("Top 10 Rated Items",
                    style: Theme.of(context).textTheme.bodyText1!.copyWith(
                        fontSize: 18.w,
                        color: Colors.white,
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(CustomIcons.best_selling, color: Color(0xFFE48C24), size: 37.w,),
                      SizedBox(width: 10.w,),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 3.w,),
                          Icon(Icons.menu, color: kTextBlackColor, size: 15.w,),
                        ],
                      ),
                    ),
                  )
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(CustomIcons.top_deals, color: Color(0xFFE48C24), size: 33.w,),
                      SizedBox(width: 10.w,),
                      Text("Top Deals",
                        style: Theme.of(context).textTheme.bodyText1!.copyWith(
                            fontSize: 18.w,
                  ...
                  InkWell(
                    onTap: (){
                      Get.to(() => DealsDetails(title:"Top Deals",));
                    },
                    child: Container(
                      height: 24.w,
                      width: 75.w,
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      Get.to(() => DealsDetails(title:"Recommended Deals",));
                    },
                    child: Container(
                      height: 24.w,
                      width: 75.w,
          ...
          Container(
              ...
              child: Text("Regular Selling Items",
                style: Theme.of(context).textTheme.bodyText1!.copyWith(
                    fontSize: 18.w,
                    color: Colors.white,
                    fontWeight: FontWeight.w700
          ...
          Container(
            ...
            child: PageView(
              children: [
                Image.asset("assets/images/house.png",fit: BoxFit.fitWidth,),
                Image.asset("assets/images/logoFrame.png",fit: BoxFit.fill,),
                Image.asset("assets/images/logoFrame.png",fit: BoxFit.fill,),
                Image.asset("assets/images/logoFrame.png",fit: BoxFit.fill,),
              ],
